    ...
    <div>
      ...
      <div className="relative bg-[#080C16] pt-28 pb-16 px-5 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="flex items-center gap-2 text-white/30 text-xs mb-6 flex-wrap">
            ...
            <span>/</span>
            <span className="text-white/50">{tour.name}</span>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              {tour.badge && (
                <span className="inline-block bg-gradient-to-r from-[#C9953A] to-[#B84420] text-white text-[10px] font-bold tracking-widest uppercase px-3 py-1 rounded-full mb-4">
                  {tour.badge}
                </span>
              )}
              <h1 className="font-bold text-white mb-3" style={{ fontSize: 'clamp(1.8rem,4vw,3.2rem)', fontFamily: 'var(--font-playfair,serif)' }}>
                {tour.name}
              </h1>
              ...
              <div className="flex gap-3">
                ...
                <a href="#booking"
                  className="flex-1 bg-gradient-to-r from-[#C9953A] to-[#B84420] text-white font-semibold text-sm px-5 py-3.5 rounded-full text-center hover:-translate-y-0.5 hover:shadow-lg transition-all">
                  Book Online
                </a>
              </div>
            </div>
      ...
      <div className="max-w-6xl mx-auto px-5 py-16 grid grid-cols-1 lg:grid-cols-3 gap-10">
        <div className="lg:col-span-2 space-y-12">
          ...
          {/* Itinerary */}
          <div>
            <h2 className="font-bold text-[#1A1208] text-2xl mb-6" style={{ fontFamily: 'var(--font-playfair,serif)' }}>
              Your Experience — Step by Step
            </h2>
            {tour.itinerary.map((step, i) => (
              <div key={i} className="flex gap-5">
                <div className="flex flex-col items-center">
                  <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#C9953A] to-[#B84420] flex items-center justify-center text-white font-bold text-sm shrink-0 shadow-md">
                    {i + 1}
                  </div>
