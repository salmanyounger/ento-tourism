...
export function ParallaxStars() {
  ...
  useEffect(() => {
    ...
    const shoot = () => {
      ...
      ss.style.cssText = `position:absolute;width:60px;height:1.5px;
        background:linear-gradient(90deg,white,transparent);border-radius:2px;
        pointer-events:none;top:${Math.random() * 60}%;left:${Math.random() * 80}%;
